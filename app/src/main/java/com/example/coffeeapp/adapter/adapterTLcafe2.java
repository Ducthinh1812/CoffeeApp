...
public class adapterTLcafe2 extends RecyclerView.Adapter<adapterTLcafe2.TLcafeHolder> {
    ...
    public adapterTLcafe2(Context context, ArrayList<LoaiCafe> TheLoaicafeArrayList) {
    ...
    @NonNull
    @Override
    public adapterTLcafe2.TLcafeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_the_loai2, parent, false);
        linearTL = view.findViewById(R.id.linearTL2);
        return new adapterTLcafe2.TLcafeHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adapterTLcafe2.TLcafeHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class TLcafeHolder extends RecyclerView.ViewHolder {
        ...
        public TLcafeHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout = itemView.findViewById(R.id.linearTL2);
            imgTL = (ImageView) itemView.findViewById(R.id.imgTL2);
            tvTenQA = (TextView) itemView.findViewById(R.id.tvtenTL2);
        }
    }
}
